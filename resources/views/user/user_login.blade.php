...
<head>
        <title>Aplikasi Masak & Rancang</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post" action="{{ url('admin')}}">{{ csrf_field()}}
				 <div class="control-group normal_text"> <h3><img src="{{ asset('images/backend_images/admin.png')}}" alt="Logo" /></h3></div>
