...
<form action="{{ route('recipe.store') }}"  enctype="multipart/form-data" method="POST" >
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
        ...
        <input type="text" name="recipename" class="form-control" placeholder="Nama Resepi">
    </div>
    ...
    <div class="form-group col-md-6">
            ...
            <input type="text" name="preparetime" class="form-control" placeholder="Masa">
    </div>

    <div class="form-group col-md-6">
            <label for="kategori"><strong>Jumlah Hidangan<span class="required">*</span></label>       
            <input type="text" class="form-control" placeholder="Hidangan" name="serves">

    </div>

    <div class="form-group">
            <strong>Bahan:</strong>
            <textarea type="text" class="form-control form-description" placeholder="Bahan-Bahan" name="ingredients" ></textarea>

    </div>

    <div class="form-group">
            <strong>Arahan:</strong>
            <textarea type="text" class="form-control form-description" placeholder="Arahan" name="directions" ></textarea>
    </div>
    ...
    <div class="form-group col-md-6">
        ...
        <option value="Tak Pedas">Tak Pedas</option>
