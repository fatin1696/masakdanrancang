...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <link rel="icon" href="images/core-img/favicon.ico">
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="{{ route('admin.login.submit') }}">{{ csrf_field()}}
				 <div class="control-group normal_text"> <img src="{{ asset('images/backend_images/admin.png')}}" alt="Logo" /></div>
